...
*/
      ...
      var factorsAction8$ = factorsClick8$.map( e => {
        ...
        makeBind(145).b(x=>x*x*x)(it4)(it6)(it7);
        makeBind(145).b(x=>x*x*x)(it4)(it6)(it7);
        makeBind(145).b(x=>x*x*x)(it4)(it6)(it7);
        makeBind(145).b(x=>x*x*x)(it4)(it6)(it7);
        makeBind(145).b(x=>x*x*x)(it4)(it6)(it7);
...
h('span.tao', ' This demonstration features twenty-five calls to bind(145) followed by a math computation (cube), a function named "it4" that sends the computation result to the WebSocket server in order to obtain a pseudo-random number. The WebSocket response is handled by a web worker that. a function named "it6a" that sends the WebSocket response to a web worker in order to obtain the number\'s prime factors, and finally, a function named "it7" that formats the worker response for the browser and augments the prime number cache. The process is stated as: '), 
h('pre', `  const bind = Bind("bind0");
  bind(145)(x=>x**3)(it4)(it6)(it7); ` ),
h('p#defsReturn'),
h('span', ' \"bind(145)(x=>x**3)(it4)(it6)(it7);\" is called twenty-five times in rapid succession. it4, it6, and it7 are discussed in the ' ),  
h('a', {props: {href: "#defs" }},  'appendix'),
h('span', '.' ),
h('p', ' Using the same function (bind) twenty-five times in rapid succession is an experiment. If bind() were followed by other functions, it could stumble all over itself. Collision-free code is guaranteed by using the function makeBind to produce anonymous copies of _bind(), as seen in the next demonstration. ' ),
h('br'),
...
h('br'),
h('br'),
h('button#factors_R', {style: {fontSize: '15px'}}, 'bind(145)(x=>x**3)(it4)(it6)(it7)'),
h('span', "~~"),
