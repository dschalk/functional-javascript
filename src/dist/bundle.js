...
/***/ (function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	  ...
	  var editB$ = sources.DOM.select('button#commit').events('click');
