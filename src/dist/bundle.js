	...
	*/
	...
	function main(sources) {
	  ...
	  */
	  ...
	  var clearClick$ = sources.DOM.select('button#clear_P').events('click').map(function () {
	    return m778_RESULT = (0, _dom.h)('div', "");
	  });

	  var factorsRecursion = function factorsRecursion(n) {
	    return bind(50)(cubeC)(prm4)(prm6)(function () {
	      if (n < 15) factorsRecursion(n + 1);
	    });
	  };
