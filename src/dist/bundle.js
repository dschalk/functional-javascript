	...
	*/
	...
	function main(sources) {
	  ...
	  */
	  ...
	  var ppFna = function ppFna(n) {
	    return (0, _dom.h)('p', { style: { color: 'red', marginLeft: '0px' } }, 'ping' + n);
	  };
	  var ppFnb = function ppFnb(n) {
	    return (0, _dom.h)('p', { style: { color: 'yellow', marginLeft: '12%' } }, 'PONG' + n);
	  };
	  ...
	  var pingpongRecursion = function pingpongRecursion(n) {
	    return function (ar) {
	      return bind(n, ar)(ppFna)(pause)(ppFnb)(function () {
	  ...
	  var result66 = function () {
	    var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(n) {
