...
/***/ (function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	  ...
	  var messages$ = sources.WS.map(function (e) {
	    ...
	    ret(v[0]).bnd(next, 'CA#$42', mMZ10).bnd(next, 'CD#$42', mMZ11).bnd(next, 'CE#$42', mMZ12).bnd(next, 'EE#$42', mMZ13).bnd(next, 'TD#$42', mMZ14).bnd(next, 'NN#$42', mMZ15).bnd(next, 'RR#$42', mMZ16).bnd(next, 'GZ#$42', mMZ17 // Comments automatically arrive after the app loads
	  ...
	  var groupPressAction$ = groupPress$.map(function (e) {
	    if (e.keyCode === 13) {
	      ...
	      bind(pMgroup)(function (v) {
	        return ret(e.target.value);
	      })(terminate);
	  ...
	  return {
	    DOM: calcStream$.map(function () {
	      return (0, _dom.h)('div.main', [(0, _dom.h)('div.image_3', [(0, _dom.h)('img.image_2', { props: { src: "logo.svg" } }), (0, _dom.h)('span', ' '), (0, _dom.h)('a', { props: { href: "https://cycle.js.org/", target: "_blank" } }, 'A Cycle.js application')]), (0, _dom.h)('div', { style: { textAlign: "center", fontWeight: "bold" } }, [(0, _dom.h)('div', { style: { fontSize: "20px", color: "#f7f700" } }, 'FUNCTIONAL REACTIVE PROGRAMMING'), (0, _dom.h)('br'), (0, _dom.h)('div', { style: { fontSize: "18px", fontStyle: "italic", color: "#07f7f7" } }, 'WITH CUSTOM MONADS AND CYCLE.JS')]), (0, _dom.h)('br'), (0, _dom.h)('div.content', [(0, _dom.h)('p', ' I am publishing this page mainly: '), (0, _dom.h)('p', ' (1) To share my "bind()" function along with a few other inventions with website developers and '), (0, _dom.h)('p', ' (2) To help people who are interested in acclimating their thought processes to functional and reactive ways of programming. In order to feel comfortable with functional, reactive code, I think novices and seasoned programmers alike must grow new synaptic structures in their brains. This comes with practice. '), (0, _dom.h)('pre', { style: { fontStyle: "italic", color: "#f7f700" } }, '      Understanding without practice\n      adrift in a sea of confusion. \n      understanding with practice\n      smooth sailing through every challenge '), (0, _dom.h)('p', ' Here is the definition of Monad: '), (0, _dom.h)('pre', { style: { color: "rgb(181, 244, 240)" } }, '    function Monad(z = \'default\', ID = \'tempMonad\') {\n      this.x = z;\n      this.id = ID;\n    }; '), (0, _dom.h)('p', ' What I call "monads" here are objects which respond affirmatively to "typeof object === Monad". They have two attributes, id and x. monad.x is what I sometimes call the "value" of a monad. '), (0, _dom.h)('p', ' bind() takes a monad as its argument and returns a function that operates on functions, returning functions similar to itself untill it encounters the "terminate" flag. This looks like bind(m)(function1)(function2)(function3) ... where m is a monad and the functions operate on the values of the monads returned by the function to their immediate left. '), (0, _dom.h)('p', ' This can be confusing. You know the functions that you are chaining. They all return monads. But what are the invisable functions that stand ready to operate on the next function you provide? '), (0, _dom.h)('p', ' The invisible functions that stand ready to operate on the next function you provide are the return values of bind(m.x) where m is the return value of the previous function. Yes, bind is executed all along the chain, you just don\t see it. '), (0, _dom.h)('p', ' Here\'s another way of saying essentially the same thing: If m is returned by the last function you put on the chain, the return value of bind(m.x) is what awaits your next addition. You don\t see it, but it\'s there. When you are done, make (terminate) the final link. The return value of the final function, a monad, will be returned. '), (0, _dom.h)('p', ' Any JavaScript value can be the value of a monad. It is easy to wrap anything in a monad, so the restriction on return values does not restrict what you can do. '), (0, _dom.h)('p', ' Like the >>= operator (called "bind") in the Haskell programming language, bind() operates on functions that take values and return monads. "ret()", defined below, resembles  Haskell\'s "return" function in that it is the left and right identity function on monads, and it takes a value as an argument and returns a monad containing that value. '), (0, _dom.h)('sp.tao', ' As you see, ret() encapsulates values that are not monads but does not return monads containing monads. There are ways to next monads within monads; for example, monad m1 becomes the value of m2 when you write: '), (0, _dom.h)('pre', '    var m2 = new Monad(m1, "m2") '), (0, _dom.h)('p', ' Here is the definition of ret(), which was used in the definitions of add() and cube(): '), (0, _dom.h)('pre', '  function ret (val, id = "default") {\n    if (val instanceof Monad && arguments.length === 2)\n      return window[val.id] = new Monad(id, val.id) \n    if (val instanceof Monad)\n      return window[val.id] = new Monad(val.x, val.id)\n    return window[id] = new Monad(val, id);\n  } '), (0, _dom.h)('pre', '    var m = ret(v)\n    m.x === v  '), (0, _dom.h)('p', ' Here is the definition of bind(): '), (0, _dom.h)('pre', { style: { color: "lightBlue" } }, '  function bind (x, ar = []) {\n    return function (func, ...args) {\n      if (func.name === "terminate") return ar;\n      var y = func(x, ...args) \n      y.id = testPrefix(args, y.id)\n      ar.push(y.x);\n      return bind(y.x, ar);\n    }\n  };  '), (0, _dom.h)('p', ' The following function uses "ar" in three places, illustrating the fact that the result of each computation in a chain is available to every computation that follows. If you only want the final result, just put ".pop()" after terminate. '), (0, _dom.h)('pre', '  bind(1)(addC(2))(cubeC)(addC(3))(multC(ar[0]))(multC(ar[0]))\n  (addC(30))(multC(1/ar[2]))(terminate)\n    // [3, 27, 30, 90, 270, 300, 10] '), (0, _dom.h)('p', ' addC, cube and multC (above) are defined as follows: '), (0, _dom.h)('pre', '    const addC = a => b => ret(a+b);\n      \n    const multC = a => b => ret(a*b);\n\n    const cubeC = a => ret(a*a*a);  '), (0, _dom.h)('p', ' When using bind(), coders provide only one argument, which can be any javascript value, icluding function, object, etc. bind()\'s second argument is an array that is automatically provided. You can substitute any array you like for the default starting array. '), (0, _dom.h)('p', ' The funtions provided to bind(m) run sequentially from left to right, using the value returned by the previous function. When "terminate" flag is provided as the final argument ar is returned.'), (0, _dom.h)('p', ' testPrefix() looks for strings prefixed by "$". If it finds one, y.id is assigned the value of the substring that follows the prefix. If no string beginning with "$" is found, y.id will not change. y.id will never be undefined because functions provided to bind must return instances of Monad. Here is the definition of testPrefix:'), (0, _dom.h)('pre', { style: { color: "rgb(213, 177, 239)" } }, '  function testPrefix (x,y) {\n    var t = y;  // y is the id of the monad calling testPrefix\n    if (Array.isArray(x)) {\n      x.map(v => {\n        if (typeof v == \'string\' && v.charAt() == \'$\') {\n           t = v.slice(1);  // Remove "$"\n        }\n      })\n    }\n   return t;\n }  '), (0, _dom.h)('span.tao', ' Values v that satisfy "v instanceOf Monad" (called "monads" in this discussion) are very different from the Haskell monads, but they are similar in that both behave like the monads of category theory without actually being category theory monads. See '), (0, _dom.h)('a', { props: { href: "http://math.andrej.com/2016/08/06/hask-is-not-a-category/", target: "_blank" } }, 'Hask is not a category.'), (0, _dom.h)('span', ' by Andrej Bauer and the '), (0, _dom.h)('a', { props: { href: '#discussion' } }, 'Discussion'), (0, _dom.h)('span', ' below. They provide a convenient interface for dealing with uncertainty and side effects in a purely functional manner. Adherence to the monad laws (see below) helps instill confidence that the monads are robust, versatile, and reliable tools for isolatin?g and chaining sequences of javascript functions. '), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span.tao', ' Reactivity occurs naturally in the Cycle.js framework. Some developers find that Cycle.js has a steep learning curve. It isn\'t so bad if you start with Andr Staltz\' '), (0, _dom.h)('a', { props: { href: "https://egghead.io/courses/cycle-js-fundamentals", target: "_blank" } }, ' Overview of Cycle.js.'), (0, _dom.h)('span', ' Its sheer elegance might take your breath away. '), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span.tao', ' The monads do not depend on Cycle.js. They can be used in React, Node, and all other browser-based applications. I happen to prefer Cycle.js working in conjunction with my Haskell websockets server. '), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span.tao', 'This project was created by and is actively maintained by me, David Schalk. The code repository is at '), (0, _dom.h)('a', { props: { href: "https://github.com/dschalk/JS-monads-stable", target: "_blank" } }, 'JS-monads'), (0, _dom.h)('span', ' You can comment at '), (0, _dom.h)('a', { props: { href: 'https://redd.it/60c2xx' } }, 'Reddit'), (0, _dom.h)('span', ' or in the Comments section near the end of this page '), (0, _dom.h)('br'), (0, _dom.h)('p', ' Snabbdom, xstream, and most of the monads and functions presented here are available in browser developer tools consoles and scratch pads. A production site would load these as modules, but this site is for experimention and learning so many supporting files are included as scripts in the index.html page. '), (0, _dom.h)('h2', 'Alternative Monad Functionality'), (0, _dom.h)('p', ' Chaining of JavaScript procedures usually occurs by means of methods inside of linked objects. rather than by means of external functions like bind(). Instances of Monad can also link by means of a method. It is called "bnd()" and it, along with "ret()", were made available as follows: '), (0, _dom.h)('pre', { style: { color: "rgb(236, 242, 186)" } }, '  Monad.prototype.bnd = function (func, ...args) {\n    var m = func(this.x, ...args)\n    var ID;\n    if (m instanceof Monad) {\n      ID = testPrefix(args, this.id);\n      window[ID] = new Monad(m.x, ID);\n      return window[ID];\n    }\n    else return m;\n  };\n\n  Monad.prototype.ret = function (a) {\n    return window[this.id] = new Monad(a, this.id);\n  }; '), (0, _dom.h)('p', ' This seems less functional, less like Haskell. It doesn\'t pass functions down the chain but rather objects with exposed methods. But is has endearing features. Look how values move along the chain until, at the end they combine to yield 42. This would be impossible with bind(), which is why bind() has ar. '), (0, _dom.h)('pre', '  ret(2).bnd(v => add(v,1).bnd(cube).bnd(p => add(p,3)\n  .bnd(() => ret(p/3).bnd(add,3).bnd(z => [v,p,z,v*p-z]))))\n    // [1,27,12,42] '), (0, _dom.h)('h2', 'Haskell Monad Laws'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('div', 'Left Identity '), (0, _dom.h)('pre', '  m.ret(v).bnd(f, ...args).x === f(v, ...args).x\n\n  ret(v).bnd(f, ...args).x === f(v, ...args).x\n\n  ret(m) === m\n\n  Haskell monad law: (return x) >>= f \u2261 f x  '), (0, _dom.h)('div#discussion', ' Right Identity  '), (0, _dom.h)('pre', '  m.bnd(m.ret) === m  For all m where \n    (m.constructor === Monad) === true    \n\n  m.bnd(ret) === m  For all m where \n    (m.constructor === Monad) === true\n\n  bind(m)(retrn)(terminate) === m  For all m where \n    (m.constructor === Monad) === true\n    \n  Haskell monad law: m >>= return \u2261 m '), (0, _dom.h)('div', ' Commutivity  '), (0, _dom.h)('pre', '  eq(m.bnd(f, ...args).bnd(g, ...args), \n  m.bnd(v => f(v, ...args).bnd(g, ...args)))\n\n  eq(bind(ret(v))(f, ...args)(g, ...args)(terminate),\n   bind(ret(3,\'m\'))(x => f(x, ...args))(g, ...args)(terminate))\n\n  Haskell: (m >>= f) >>= g \u2261 m >>= ( \\x -> (f x >>= g) ) '), (0, _dom.h)('span', { style: { fontSize: "18px", color: "magenta", fontStyle: "italic" } }, 'Additional expressions showing "ret" is the left and right identity function. '), (0, _dom.h)('pre', '  m.ret(3).bnd(ret).bnd(cube).bnd(ret).x === \n    m.ret(3).bnd(cube).x\n\n  bind(ret(3))(ret)(cube)(ret)(terminate).pop().x === \n    bind(ret(3))(cube)(terminate).pop().x '), (0, _dom.h)('span', { style: { fontSize: "18px", color: "magenta", fontStyle: "italic" } }, 'Examples demonstrating commutivity'), (0, _dom.h)('pre', '  eq(bind(ret(3))(ret)(cube)(ret)(terminate),\n    bind(ret(3))(cube)(terminate)) \n  \n  eq(m.ret(3).bnd(ret).bnd(cube).\n    bnd(ret),m.ret(3).bnd(cube)) '), (0, _dom.h)('a', { props: { href: '#top' } }, 'Back To The Top'), (0, _dom.h)('h3', ' Disussion '), (0, _dom.h)('span.tao', ' The Haskell statement '), (0, _dom.h)('span.turk6', 'f \u2261 g'), (0, _dom.h)('span', ' means that f x == g x for all Haskell values x in the domain of f. That is the test applied to Javascript expressions in the "Monad Laws" section (above). Neither the == nor the === operator would provide useful information about the behavior of instances of Monad. Those operators test objects for location in memory. If the left and right sides of predicates create new instances of m, then the left side m and the right side m wind up in different locations in memory. So we expect m.ret(3) === m.ret(3) to return false, and it does. We want to answer the question \u2261 answers in Haskell: Can the left and right sides be substituted for one another and still yield the same results.'), (0, _dom.h)('h3', 'Comparison With Haskell Monads'), (0, _dom.h)('p', ' By the definition of "monad" in category theory, all morphisms (functions by analogy here) are commutative and have a left and right identity morphism. ret() is our left and right identity function. The expression eq(m1,m2) returns true if and only if m1.x === m2.x and m1.id === m2.id. m1 === m2 returns false if m1 and m2 are in different locations in memory. The Haskell "≡" operator provides information simular to eq(). '), (0, _dom.h)('pre', '  function eq (mon1, mon2) {\n    if (mon1.id === mon2.id && mon1.x === mon2.x) return true;\n    else return false;\n  } '), (0, _dom.h)('p', ' Here are some identity comparisons: '), (0, _dom.h)('pre', '  bind(m)(ret,\'m\')(terminate) === m  // Right identity \n  ret(m) === m                       // Left Identity  \n  eq(bind(m)(ret)(cube)(terminate),\n    cube(m.x))                       // Similar to Haskell right identity\n  bind(retrn(m))(terminate) === m    // Similar to Haskell left identity\n  eq(bind(m)(ret)(cube)(ret)(terminate),\n    cube(m.x))                       // Inserting ret has no effect   '), (0, _dom.h)('p', ' The Haskell identity laws are:'), (0, _dom.h)('pre', '    return a >>= k \u2261 k a   // Left identity\n    m >>= return \u2261 m       // Right identity  '), (0, _dom.h)('p', ' The Haskell commutivity law is: '), (0, _dom.h)('pre', '  (m >>= f) >>= g \u2261 m >>= ( \\x -> (f x >>= g) ) '), (0, _dom.h)('p', ' And here it is in terms of our JavaScript monads: '), (0, _dom.h)('pre', '  eq(bind(ret(3,\'m\'))(f, ...args)(g, ...args)(terminate),\n     bind(ret(3,\'m\'))(x => f(x, ...args))(g, ...args)(terminate))\n  \n  EXAMPLE:\n\n  eq(bind(ret(3,\'m\'))(add,1)(cube)(terminate),\n     bind(ret(3,\'m\'))(x => add(1,x))(cube)(terminate)) '), (0, _dom.h)('span.tao', ' The Haskell programming language borrowed the term "monad" from the branch of mathematics known as category theory. This was apropriate because Haskell monads, along with the function return and the "bind" operator >>=, behave quite a bit like category theory monads, and the inspiration for them came out of category theory. For Haskell monads to actually be category theory monads, they would need to reside in a category-theory category. They don\'t, although the Haskell mystique tends to give newcommers to the language the impression that they do. See '), (0, _dom.h)('a', { props: { href: "http://math.andrej.com/2016/08/06/hask-is-not-a-category/", target: "_blank" } }, 'Hask is not a category.'), (0, _dom.h)('br'), (0, _dom.h)('p', ' Research into ways of defining a Haskell category appears to be ongoing. This research involves tinkering with special constraints, omitted features, and definitions of morphisms that are not Haskell functions. When a definition of the category is established, Haskell monads are then shown to be, in some contrived context, category-theory monads. Devising such schemes are instructive academic exercises, but I think application developers will always want and need tools which lie outside of the closed space of any category. '), (0, _dom.h)('p', ' However, imitating definitions and patterns found in category theory, as Haskell does in defining the functor, monoid, and monad type classes, was a stroke of genius that vastly enriched the Haskell programming language and brought it into the mainstream as a viable alternative to java, c++, etc.  This website runs efficiently on a Haskell websockets server. The modified Haskell Wai Websockets server has proven to be extraordinarily easy to maintain as new requirements become necessary. For example, modifying the server to send chat messages and shared todo lists only to members of the same group was a trivial task. It required just a few lines of no-brainer pattern-matching code. '), (0, _dom.h)('span.tao', ' Other JavaScript monad schemes mirror type theory and Haskell with their type constructors and monads that operate on types. Examples include '), (0, _dom.h)('a', { props: { href: "https://curiosity-driven.org/monads-in-javascript" } }, "Curiosity-Driven"), (0, _dom.h)('span', ' and '), (0, _dom.h)('a', { props: { href: "https://github.com/fantasyland/fantasy-land" } }, "Fantasy Land."), (0, _dom.h)('span', ' For me, superimposing such abstractions over Javascript diminishes it. It is easy to include some type checking code in function definitions where it is thought to be helpful. For example, if someone enters inappropriate data in a form, a message explaining the mistake can be displayed. I enjoy the freedom and versitility of JavaScript as it is. '), (0, _dom.h)('h2', ' Monad Demonstrations '), (0, _dom.h)('p', ' The demonstrations below include persistent, shared todo lists, text messaging, and a simulated dice game with a traversable history (all group members see your score decrease or increase as you navegate backwards and forwards). Monads are shown performing lengthy mathematical computations asycronously in web workers. Variations on the Monad theme encapsulate state. The error checking monad carries occurances of NaN and runtime errors through sequences of computations much like the Haskell Maybe monad. '), (0, _dom.h)('span.tao', ' The game code is fairly concise and intuitive. A quick walk-through is presented at.'), (0, _dom.h)('a', { props: { href: '#gameExplanation' } }, 'here'), (0, _dom.h)('span', '. To see monadic functionality at work, I suggest that you take a look at the section captioned '), (0, _dom.h)('a', { props: { href: '#asyncExplanation' } }, 'Asynchronous Processes'), (0, _dom.h)('br'), (0, _dom.h)('p', ' But it might be best to first proceed down the page and see the examples of Monad instances manipulating data. If you are trying to wrap you head around the concept of pure, chainable functions, such as the functions in the Underscore and Jquery libraries, understanding our monads might elevate you to the comfort zone you seek. '), (0, _dom.h)('h3', 'The Game'), (0, _dom.h)('p', 'People who are in the same group, other than the default group named "solo", share the same todo list, chat messages, and simulated dice game. In order to see any of these, you must establish a unique identity on the server by logging in. The websockets connection terminates if the first message the server receives does not come from the sign in form. You can enter any random numbers, letters, or special characters you like. The server checks only to make sure someone hasn\'t already signed in with the sequence you have selected. If you log in with a name that is already in use, a message will appear and this page will be re-loaded in the browser after a four-second pause. '), (0, _dom.h)('p', ' Data for the traversable game history accumulates until a player scores three goals and wins. The data array is then erased and the application is ready to start accumulating a new history. '), (0, _dom.h)('p', ' Your user name for trying out the game, todo list, and chat demonstrations is a random permutation of the first 14 letters of the alphabet. In the comments section, soon to be near the bottom of this page, you can chose your own persistent user name and password. These facilitate leaving comments which can later be revised or removed.'), (0, _dom.h)('br')]), (0, _dom.h)('hr.len90', { style: { display: mMgameDiv2.x } }), (0, _dom.h)('br.len90', { style: { display: mMgameDiv2.x } }), (0, _dom.h)('div.heading', { style: { display: mMgameDiv2.x } }, 'Game, Todo List, Text Messages'), (0, _dom.h)('div#gameDiv2', { style: { display: mMgameDiv2.x } }, [(0, _dom.h)('br'), (0, _dom.h)('div#leftPanel', { style: { display: mMgameDiv2.x } }, [(0, _dom.h)('p', 'RULES: If clicking two numbers and an operator (in any order) results in 20 or 18, the score increases by 1 or 3, respectively. If the score becomes 0 or is evenly divisible by 5, 5 points are added. A score of 25 results in one goal. That can only be achieved by arriving at a score of 20, which jumps the score to 25. Directly computing 25 results in a score of 30, and no goal. Each time RL is clicked, one point is deducted. Three goals wins the game. '), (0, _dom.h)('p', { style: { color: 'red', fontSize: '20px' } }, mMgoals2.x), buttonNode, (0, _dom.h)('br'), (0, _dom.h)('button#4.op', 'add'), (0, _dom.h)('button#5.op', 'subtract'), (0, _dom.h)('button#6.op', 'mult'), (0, _dom.h)('button#7.op', 'div'), (0, _dom.h)('button#8.op', 'concat'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('div#dice', { style: { display: mMdice.x } }, [(0, _dom.h)('button#roll.tao1', 'ROLL'), (0, _dom.h)('button#back.tao100', 'BACK'), (0, _dom.h)('button#ahead.tao1', 'FORWARD'), (0, _dom.h)('div.tao', 'Selected numbers: ' + gameMonad.fetch3().join(', ')), (0, _dom.h)('div.tao', 'Operator: ' + gameMonad.fetch2() + ' '), (0, _dom.h)('div.tao', 'Index: ' + gameMonad.s[1]), (0, _dom.h)('button#clear', 'Clear selected numbers'), (0, _dom.h)('p', ' When traversing the game history, any time there are two selected numbers you can click any operator to obtain a result; or you can clear the selected numbers and click numbers of your choice. You can do anything you want with displayed numbers, but if there is a previously selected operater and you click a second number (shown after "Selected numbers:"), a computation will be performed using the previously selected operator. If that happens and it isn\'t what you want, you can back up and select a different operater before clicking a second number.'), (0, _dom.h)('span', 'Change group: '), (0, _dom.h)('input#group', 'test'), (0, _dom.h)('p', mMsoloAlert.x), (0, _dom.h)('p', ' You can change your name by entering a comma-separated name and password below. The combination will go into a persistent file accessible by the server. You can use this combination to edit or delete your saved comments now or in the future after you log in. '), (0, _dom.h)('span.red', mMregister.x), (0, _dom.h)('label', { style: { display: mMshowRegister.x } }, 'Register or log in here:'), (0, _dom.h)('input.register', { style: { display: mMshowRegister.x } })])]), (0, _dom.h)('div#rightPanel', { style: { display: 'block' } }, [(0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('button#todoButton.cow', 'TOGGLE TODO_LIST'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('button#chat2.cow', 'TOGGLE CHAT'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('h3', 'User Data Currently Held in the Server\'s State TVar'), (0, _dom.h)('div', stateArray), (0, _dom.h)('br'), (0, _dom.h)('span', '*****************************************************'), (0, _dom.h)('div', { style: { fontSize: "14 px" } }, 'Name: ' + pMname.x), (0, _dom.h)('div', { style: { fontSize: "14 px" } }, 'Group: ' + pMgroup.x), (0, _dom.h)('br'), (0, _dom.h)('div', { style: { fontSize: "14 px" } }, gameData), (0, _dom.h)('br'), (0, _dom.h)('div#a100', ' _________________________________________________ '), (0, _dom.h)('p.italic', ' Join group "t" if you want to see some previously created tasks. '), (0, _dom.h)('div', { style: { display: showTodoDiv } }, [(0, _dom.h)('div', taskMonad.html), (0, _dom.h)('div', 'Enter author, responsible person, and task here: '), (0, _dom.h)('input.newTask')]), (0, _dom.h)('br'), (0, _dom.h)('span#alert', mMalert.x), (0, _dom.h)('br'), (0, _dom.h)('span#alert2'), (0, _dom.h)('br'), (0, _dom.h)('div#chatDiv', { style: { display: showChatDiv } }, [(0, _dom.h)('div#messages', [(0, _dom.h)('span', 'Message: '), (0, _dom.h)('input.inputMessage'), (0, _dom.h)('div', messages), (0, _dom.h)('br')])])])]), (0, _dom.h)('div#a100', ' ____________________________________________________________________________________________________________ '), (0, _dom.h)('div.content', [
	      ...
	      */
	      ...
	      (0, _dom.h)('span', { style: { fontSize: "18px", color: "magenta", fontStyle: "italic" } }, 'Analogues to the Haskell Monad Laws'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('div', 'Left Identity '), (0, _dom.h)('pre', '  m.ret(v).bnd(f, ...args).x === f(v, ...args).x\n\n  ret(v).bnd(f, ...args).x === f(v, ...args).x\n\n  retrn(m) === m\n\n  Haskell monad law: (return x) >>= f \u2261 f x  '), (0, _dom.h)('div#discussion', ' Right Identity  '), (0, _dom.h)('pre', '  m.bnd(m.ret) === m  For all m where \n    (m.constructor === Monad) === true    \n\n  m.bnd(ret) === m  For all m where \n    (m.constructor === Monad) === true\n\n  bind(m)(retrn)(terminate) === m  For all m where \n    (m.constructor === Monad) === true\n    \n  Haskell monad law: m >>= return \u2261 m '), (0, _dom.h)('div', ' Commutivity  '), (0, _dom.h)('pre', '  m.bnd(f, ...args).bnd(g, ...args).x === \n    m.bnd(v => f(v, ...args).bnd(g, ...args)).x\n\n  Haskell monad law: (m >>= f) >>= g \u2261 m >>= ( \\x -> (f x >>= g) ) '), (0, _dom.h)('span', { style: { fontSize: "18px", color: "magenta", fontStyle: "italic" } }, 'Additional expressions showing "ret" is the left and right identity function. '), (0, _dom.h)('pre', '  m.ret(3).bnd(ret).bnd(cube).bnd(ret).x === \n    m.ret(3).bnd(cube).x\n\n  bind(ret(3))(ret)(cube)(ret)(terminate).pop().x === \n    bind(ret(3))(cube)(terminate).pop().x '), (0, _dom.h)('span', { style: { fontSize: "18px", color: "magenta", fontStyle: "italic" } }, 'Examples demonstrating commutivity'), (0, _dom.h)('pre', '  m.ret(0).bnd(add, 3).bnd(cube).x === \n    m.ret(0).bnd(v => add(v,3).bnd(cube)).x \n\n  bind(ret(0))(add,3)(cube)(terminate).pop().x === \n    bind(ret(0))(v=>add(v,3))(cube)(terminate).pop().x '), (0, _dom.h)('a', { props: { href: '#top' } }, 'Back To The Top'), (0, _dom.h)('h3', ' Disussion '), (0, _dom.h)('span.tao', ' The Haskell statement '), (0, _dom.h)('span.turk6', 'f \u2261 g'), (0, _dom.h)('span', ' means that f x == g x for all Haskell values x in the domain of f. That is the test applied to Javascript expressions in the "Monad Laws" section (above). Neither the == nor the === operator would provide useful information about the behavior of instances of Monad. Those operators test objects for location in memory. If the left and right sides of predicates create new instances of m, then the left side m and the right side m wind up in different locations in memory. So we expect m.ret(3) === m.ret(3) to return false, and it does. We want to answer the question \u2261 answers in Haskell: Can the left and right sides be substituted for one another and still yield the same results.'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('p'), (0, _dom.h)('p'), (0, _dom.h)('p', '.'), (0, _dom.h)('p', '.'), (0, _dom.h)('p', '.'), (0, _dom.h)('p', '.'), (0, _dom.h)('p', '.'), (0, _dom.h)('p'), (0, _dom.h)('p'), (0, _dom.h)('p'), (0, _dom.h)('p'), (0, _dom.h)('p')])]);
	    })
	  };
	}
