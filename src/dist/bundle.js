	...
	function main(sources) {
	  ...
	  */
	  ...
	  var demo2Action$ = printingPress$.map(function (e) {
	    ...
	    ;
	    if (e.keyCode === 13) {
	      bind2(e.target.value)(cubeP)(addP(3))(function (a) {
	        return a + ar[0] + ar[1] - 18;
	      })(multP(1 / 3))(addP(-11))(function () {
	        return ar[1] + ar[2] + ar[3];
	      })(terminate);
	    }
	  });
