	...
	function main(sources) {
	  ...
	  var messages$ = sources.WS.map(function (e) {
	    ...
	    mMZ11.bnd(function () {
	      ...
	      console.log('The message was typeof ar', typeof ar === 'undefined' ? 'undefined' : _typeof(ar));
	    });
	  ...
	  var solve = function solve() {
	    mMZ3.bnd(function (a) {
	      ...
	      mMZ3.bnd(function (b) {
	        mMquad6.ret(b + ' * x ');
	        mMZ3.bnd(function (c) {
	          mMtemp.ret([a, b, c]).bnd(fmap3, qS4, 'mMtemp2').bnd(function (result) {
	            var x = result[0];
	            var y = result[1];
	            if (x === 0) {
