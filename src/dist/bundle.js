	...
	function main(sources) {
	  ...
	  */
	  ...
	  var doubleAction$ = doublePress$.map(function (e) {
	    mMZ19.bnd(bind(bind(pInt(e.target.value))(function (v) {
	      return v * v * v;
	    })(function (v) {
	      return v + 3;
	    })(function (v) {
	      return v * v;
	    })(terminate)[3] / 100)(function (v) {
	      return v * v;
	    })(terminate)[1] / 3); // Now the first bind is working.
	    if (e.keyCode === 13) {
