...
/***/ (function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	  ...
	  var messages$ = sources.WS.map(function (e) {
	    ...
	    ret(v[0]).bnd(next, 'CA#$42', mMZ10).bnd(next, 'CD#$42', mMZ11).bnd(next, 'CE#$42', mMZ12).bnd(next, 'EE#$42', mMZ13).bnd(next, 'TD#$42', mMZ14).bnd(next, 'NN#$42', mMZ15).bnd(next, 'RR#$42', mMZ16).bnd(next, 'ZZ#$42', mMZ17 // Comments automatically arrive after the app loads
	    ).bnd(next, 'ZN#$42', mMZ18).bnd(next, 'ZE#$42', mMZ19).bnd(next, 'ZD#$42', mMZ20).bnd(next, 'TA#$42', mMZ21 // Automatic task list load on group change
