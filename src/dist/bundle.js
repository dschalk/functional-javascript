	  ...
	  */
	  ...
	  return {
	    DOM: calcStream$.map(function () {
	      return (0, _dom.h)('div.main', [(0, _dom.h)('div.image_3', [(0, _dom.h)('img.image_2', { props: { src: "logo.svg" } }), (0, _dom.h)('span', ' '), (0, _dom.h)('a', { props: { href: "https://cycle.js.org/", target: "_blank" } }, 'A Cycle.js application')]), (0, _dom.h)('div', { style: { textAlign: "center", fontWeight: "bold" } }, [(0, _dom.h)('div', { style: { fontSize: "20px", color: "#f7f700" } }, 'FUNCTIONAL REACTIVE PROGRAMMING'), (0, _dom.h)('br'), (0, _dom.h)('div', { style: { fontSize: "18px", fontStyle: "italic", color: "#07f7f7" } }, 'WITH CUSTOM MONADS AND CYCLE.JS')]), (0, _dom.h)('br'), (0, _dom.h)('div.content', [(0, _dom.h)('p', ' I am publishing this page mainly: '), (0, _dom.h)('span.tao', ' (1) To show how "monads", which are objects created by expressions such as '), (0, _dom.h)('span', { style: { color: '#ef7732' } }, 'm = new Monad(a,"m").'), (0, _dom.h)('span', ' can promote efficiency, maintainability, and robustness in front-end web applications. Functions that return promises, monads, and other values can be linked with one another in a single chain of encapsulated procedures that produce only one side effect: the final result. '), (0, _dom.h)('a', { props: { href: '#chain' } }, 'Linked Procedures.'), (0, _dom.h)('br'), (0, _dom.h)('p', ' (2) To help people who are interested in acclimating their thought processes to functional and reactive ways of programming. In order to feel comfortable with functional, reactive code, I think novices and seasoned programmers alike need to grow new synaptic connections in their brains. This comes with practice. '), (0, _dom.h)('pre', { style: { fontStyle: "italic", color: "#f7f700" } }, '      Understanding without practice\n      adrift in a sea of confusion. \n      understanding with practice\n      smooth sailing through every challenge '), (0, _dom.h)('p', ' This is the definition of Monad: '), (0, _dom.h)('pre', { style: { color: "rgb(181, 244, 240)" } }, '    function Monad(z = \'default\', ID = \'tempMonad\') {\n      this.x = z;\n      this.id = ID;\n    }; '), (0, _dom.h)('p', ' Before explaining how the monads work, I invite you to try out some examples of monads in action.'), (0, _dom.h)('h2', ' A Few Monad Demonstrations '), (0, _dom.h)('p', ' The demonstrations below include persistent, shared todo lists, text messaging, and a simulated dice game with a traversable history. All group members see your score decrease or increase as you navigate backwards and forwards. '), (0, _dom.h)('span.tao', ' The game code is fairly concise and intuitive. A quick walk-through is presented at.'), (0, _dom.h)('a', { props: { href: '#gameExplanation' } }, 'here'), (0, _dom.h)('span', '. To see monadic functionality at work, I suggest that you take a look at the section captioned '), (0, _dom.h)('a', { props: { href: '#asyncExplanation' } }, 'Asynchronous Processes'), (0, _dom.h)('br'), (0, _dom.h)('p', ' But it might be best to first proceed down the page and see the examples of Monad instances manipulating data. If you are trying to wrap you head around the concept of pure, chainable functions, such as the functions in the Underscore and Jquery libraries, understanding our monads might elevate you to the comfort zone you seek. '), (0, _dom.h)('h3', 'The Game'), (0, _dom.h)('p', 'People who are in the same group, other than the default group named "solo", share the same todo list, chat messages, and simulated dice game. In order to see any of these, you must establish a unique identity on the server by logging in. The websockets connection terminates if the first message the server receives does not come from the sign in form. You can enter any random numbers, letters, or special characters you like. The server checks only to make sure someone hasn\'t already signed in with the sequence you have selected. If you log in with a name that is already in use, a message will appear and this page will be re-loaded in the browser after a four-second pause. '), (0, _dom.h)('p', ' Data for the traversable game history accumulates until a player scores three goals and wins. The data array is then erased and the application is ready to start accumulating a new history. '), (0, _dom.h)('p', ' Your user name for trying out the game, todo list, and chat demonstrations and for leaving comments is a thirteen digit random number. In the game section and in the comments section near the bottom of this page, you can chose your own persistent user name and password. Knowing your password facilitates leaving comments which you can later revise or remove.'), (0, _dom.h)('br')]), (0, _dom.h)('hr.len90', { style: { display: mMgameDiv2.x } }), (0, _dom.h)('br.len90', { style: { display: mMgameDiv2.x } }), (0, _dom.h)('div.heading', { style: { display: mMgameDiv2.x } }, 'Game, Todo List, Text Messages'), (0, _dom.h)('div#gameDiv2', { style: { display: mMgameDiv2.x } }, [(0, _dom.h)('br'), (0, _dom.h)('div#leftPanel', { style: { display: mMgameDiv2.x } }, [(0, _dom.h)('p', 'RULES: If clicking two numbers and an operator (in any order) results in 20 or 18, the score increases by 1 or 3, respectively. If the score becomes 0 or is evenly divisible by 5, 5 points are added. A score of 25 results in one goal. That can only be achieved by arriving at a score of 20, which jumps the score to 25. Directly computing 25 results in a score of 30, and no goal. Each time RL is clicked, one point is deducted. Three goals wins the game. The code is in an appendix.'), (0, _dom.h)('p', { style: { color: 'red', fontSize: '20px' } }, mMgoals2.x), buttonNode, (0, _dom.h)('br'), (0, _dom.h)('button#4.op', 'add'), (0, _dom.h)('button#5.op', 'subtract'), (0, _dom.h)('button#6.op', 'mult'), (0, _dom.h)('button#7.op', 'div'), (0, _dom.h)('button#8.op', 'concat'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('div#dice', { style: { display: mMdice.x } }, [(0, _dom.h)('button#roll.tao1', 'ROLL'), (0, _dom.h)('button#back.tao100', 'BACK'), (0, _dom.h)('button#ahead.tao1', 'FORWARD'), (0, _dom.h)('div.tao', 'Selected numbers: ' + gameMonad.fetch3().join(', ')), (0, _dom.h)('div.tao', 'Operator: ' + gameMonad.fetch2() + ' '), (0, _dom.h)('div.tao', 'Index: ' + gameMonad.s[1]), (0, _dom.h)('button#clear', 'Clear selected numbers'), (0, _dom.h)('p', ' When traversing the game history, any time there are two selected numbers and a selected operator, a computation will be performed. You can clear the selected numbers and substitute others, and if you don\'t want a selected operator you can select another one.'), (0, _dom.h)('span', 'Change group: '), (0, _dom.h)('input#group', 'test'), (0, _dom.h)('p', mMsoloAlert.x), (0, _dom.h)('p', ' You can change your name by entering a comma-separated name and password below. The combination will go into a persistent file. You can use this combination in the future to edit or delete your saved comments. '), (0, _dom.h)('span.red', mMregister.x), (0, _dom.h)('label', { style: { display: mMshowRegister.x } }, 'Register or log in here:'), (0, _dom.h)('input.register', { style: { display: mMshowRegister.x } })])]), (0, _dom.h)('div#rightPanel', { style: { display: 'block' } }, [(0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('button#todoButton.cow', 'TOGGLE TODO_LIST'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('button#chat2.cow', 'TOGGLE CHAT'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('p#display', '' + mMfactors23.x.split(",").length), (0, _dom.h)('input#display2', 'Message: '), (0, _dom.h)('br'), (0, _dom.h)('span', '__________________________________________ '), (0, _dom.h)('div', { style: { fontSize: "14 px" } }, 'Name: ' + pMname.x), (0, _dom.h)('div', { style: { fontSize: "14 px" } }, 'Group: ' + pMgroup.x), (0, _dom.h)('br'), (0, _dom.h)('div', { style: { fontSize: "14 px" } }, gameData), (0, _dom.h)('br'), (0, _dom.h)('div#a100', ' _____________________________________ '), (0, _dom.h)('p.italic', ' Join group "t" if you want to see some previously created tasks. '), (0, _dom.h)('div', { style: { display: showTodoDiv } }, [(0, _dom.h)('div', taskMonad.html), (0, _dom.h)('div', 'Enter author, responsible person, and task here: '), (0, _dom.h)('input.newTask')]), (0, _dom.h)('br'), (0, _dom.h)('span#alert', mMalert.x), (0, _dom.h)('br'), (0, _dom.h)('span#alert2'), (0, _dom.h)('br'), (0, _dom.h)('div#chatDiv', { style: { display: showChatDiv } }, [(0, _dom.h)('div#messages', [(0, _dom.h)('span', 'Message: '), (0, _dom.h)('input.inputMessage'), (0, _dom.h)('div', messages), (0, _dom.h)('br')])])]), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span#m80', m80.x), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span', '_____________________________________________________________________________________'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('div.content', [(0, _dom.h)('h2', 'Monads'), (0, _dom.h)('p', ' As mentioned above, "monads" are objects "m" for which "m instanceof Monad" returns true. Using "instance" in the JavaScript sense of instantiate, var mon = new Monad(0,"mon") instantiates a monad named "mon" which encapsulates the value x. In other words, mon.id === "mon" and mon.x === 0 both return true'), (0, _dom.h)('p#chain', ' The functions bind() and ret() are similar in some ways to >>= (known as "bind") and return in the Haskell programming language. But here, in this astonishingly chaotic world of JavaScript, there is only one type of monad and that type is any JavaScript value. Functions used in chains of computations operate on only one type: every possible JavaScript value. Add to that the fact that values returned by chained functions can be any JavaScript value and you see an example of the potential for creativity and confusion of plain vanilla JavaScript. '), (0, _dom.h)('p', ' bind() facilitates the linking of synchronous functions and promises in the same chain. In the functions below, the suffix "C" designates curried functions that return ordinary values. The suffixes M and P are for curried functions that return monads and curried functions that return promises respectively. The definitions are in Appendix B. All three varieties are used in the sequence below along with "pause" which returns whatever it is given after two seconds. '), (0, _dom.h)('pre', { style: { color: 'lightBlue' } }, '  bind(3)(pause)(cubeP)(squareC)(pause)\n  (addC(-727))(square)(terminate)\n  .pop().then(v => console.log(v.x))'), (0, _dom.h)('p', ' The sequence ran almost to completion in 69 microseconds and then waited 6 seconds; 2 for pause, 2 for cubeP and 2 more for the second occurrence of pause before displaying "4", which is the square of (3*3*3)*(3*3*3)-727.  Under the hood, bind() linked the promises with the Promises "then" method, which always returns a promise. When all functions in a sequence are synchronous, bind does not use Promises. '), (0, _dom.h)('p', ' Working in a Haskell-like mode, bind() operates on functions that return monads, but bind() can do more than that. Arguments to bind() can be maps of monads or values of any kind to monads or values of any kind, and maps of promises to promises that resolve to monads or anything else. Another chain of computations is shown below in the "Web Workers With bind()" section.'), (0, _dom.h)('h3', { style: { color: "yellow" } }, 'CAUTION'), (0, _dom.h)('p', ' Functions provided to bind() must be single-argumnet functions. That is not a substantial restriction because any function can be curried and thereby become a function of one argument. Suppose you have a function "f" that takes three arguments. In that case, f(a)(b) is a function that takes one argument.  So instead of bind(f,a,b) or bind(f(a,b)), write bind(f(a)(b)). bind(x)(f(a)(b)) will return a function that calls f(a)(b)(x) or, if x is a monad, f(a)(b)(x.x).'), (0, _dom.h)('p', ' All functions defined by f(a,b) {do things} have an equivalent curried alternative; namely, const f = a => b => {do things}. For example, the curried version of "function mult (a,b) {return a*b}" is "const mult = a => b => a*b". With the curried definition, mult(3) is a function that triples any numeric argument it receives. This is how all Haskell functions are designed. Curried functions have more potential uses than ordinary functions, and they require less syntactical clutter. '), (0, _dom.h)('a', { props: { href: '#top' } }, 'Back to the top'), (0, _dom.h)('p', ' When writing code, I pay attention to types and sometimes type-check to avoid crashes and for the convenience people using my websites. For example, if a user enters the wrong type of data it is helpful to display a message explaining why nothing is happening. This is a good way to prevent sockets from disconnecting in Websockets applications. I prefer ad hoc type checking over converting JavaScript into a strongly typed language with libraries like Typescript. '), (0, _dom.h)('h3', 'More about monads'), (0, _dom.h)('p', ' ret() is a convenient function for wrapping values in monads. It is also the left and right identity function for monads as is discussed further down the page in the Haskel Monad Laws section. '), (0, _dom.h)('pre', '  function ret (val = 0, id = "retDefault") {\n    return window[id] = new Monad(val, id);\n  } '), (0, _dom.h)('p', ' A chain of computations ends when it encounters the "terminate" flag. An array containing the value of every monad returned by the linked computations is then returned. Here\'s an example: '), (0, _dom.h)('pre', '  bind(0)(v => ret(v+3))(v => ret(v*v*v))(terminate) // [0,3,27] '), (0, _dom.h)('p', ' Despite the way it looks, (v => ret(v+3)) doesn\'t take (v => ret(v*v*v)) as its argument. The function returned by bind(v => ret(v+3).x) operates on (v => ret(v+3)). '), (0, _dom.h)('p', '  The following definition of bind() handles promises and monads. I retained the console.log lines so I could better demonstrate what happens in the examples.'), (0, _dom.h)('pre', { style: { color: "lightBlue" } }, '  function bind (x, arr=[]) {\n    this.ar = arr;\n    var ar = arr;\n    ar.push(x instanceof Monad ? x.x : x)\n    if (ar.length === 0) ar = [x];\n    return function debug8 (func) {\n      if (func.name === "terminate") return ar;\n      if (x instanceof Promise) {\n        var p = x.then(v => func(v instanceof Monad ? v.x : v));\n        return bind(p,ar)\n      }\n      if (x instanceof Monad) {\n        return bind(func(x.x),ar);\n      }\n      return bind(func(x),ar);\n    };\n  };   '), (0, _dom.h)('p', ' As is apparent from the definition of bind(), the invisible function that stands ready to operate on the function ahead of it in a chain is the return value of bind() (which is a function) applied to the return value of the previous function. "bind(x)" for some value "x" is explicitly coded only at the beginning of a chain, but bind() executes on each link, all the way to the "terminate" flag. '), (0, _dom.h)('p', ' Here\'s another way of saying essentially the same thing: If "x" is the most recent argument to bind() and "func" is the most recent argument to the function returned by bind(x,ar), the return value of bind(func(x)) - or bind(func(x.x) if x is a monad - stands ready to operate on the next function you add to the chain. '), (0, _dom.h)('p', ' I did my best to plainly describe what bind does and it still looks like a head scrather. The beauty of it is that a developer does not need to write the voluminous, error-prone, hard-to-follow code that would be necessary without a higher-order function like bind(). When you look at a chain of functions following a call to bind, you can easily predict the result you will get unless an asynchronous function in the chain receives user input, Websockets messages, or some other kind of unpredictable data. You could also generate random numbers in the chain. Whatever the case may be, the code could not be easier to understand, unless you peek under the hood that is. '), (0, _dom.h)('p', ' The result of every computation in a chain of synchronous functions is available to every computation that comes after it. Here\'s an example: '), (0, _dom.h)('pre', { style: { fontSize: "12px" } }, 'bind(1)(addC(2))(cubeC)(addC(3))(multC(ar[1]))(multC(ar[1]))\n(addC(30))(multC(1/ar[3]))(terminate) // [1,3,27,30,90,270,300,10]  '), (0, _dom.h)('p', ' Or, equivalently: '), (0, _dom.h)('pre', '  bind(1)(v=>ret(v+2))(v=>ret(v*v*v))(v=>ret(v+3))\n  (v=>ret(v*(ar[1])))(v=>ret(v*(ar[1])))(v=>ret(v+30))\n  (v=>ret(v*(1/ar[3])))(terminate)\n   // [1, 3, 27, 30, 90, 270, 300, 10] '), (0, _dom.h)('p', ' Or to get only the final result: '), (0, _dom.h)('pre', 'bind(1)(addC(2))(cubeC)(addC(3))(multC(ar[1]))(multC(ar[1]))\n(addC(30))(multC(1/ar[3]))(terminate).pop()  // 10  '), (0, _dom.h)('p', ' addC, and multC (above) are curried functions defined as follows: '), (0, _dom.h)('pre', '    const addC = a => b => ret(a+b);\n    const multC = a => b => ret(a*b); '), (0, _dom.h)('h3', 'Web Workers With bind()'), (0, _dom.h)('p', ' There will be a discussion of MonadItter further down this page. It is used to parse incoming Websockets messages. Here, it prevents the functions that follow it from executing before data arrives from a Web Worker. '), (0, _dom.h)('p', ' I am presenting this example now to supplement the examples of more contrived asynchronous functions like CubeP and AddP, functions that wait two seconds before doing some arithmetic. Here is the definition of largestPrime();'), (0, _dom.h)('pre', 'function largestPrime (x) {bind(x)(prm5)(split2)(terminate)\n.pop()\n.then(v => console.log(v.pop(),"Is the largest prime factor of",x))} '), (0, _dom.h)('p', ' Here are the results of running largestPrime on 1992 ,1234567, and 1234568: '), (0, _dom.h)('pre', '16:06:33.838 largestPrime(1992)\n16:06:33.890 VM4757:1  83 Is the largest prime factor of 1992\n\n16:13:03.082 largestPrime(1234567)\n16:13:13.503 VM4757:1  9721 Is the largest prime factor of 1234567\n\n16:15:53.400 largestPrime(1234568)\n16:15:54.368 VM4757:1  154321 Is the largest prime factor of 1234568 '), (0, _dom.h)('p', ' It took almost ten seconds for largestPrime(1234567) to get its result from the worker, but largestPrime(1234568) ran in under one second. That is because primesMonad (discussed later) caches computed prime numbers. '), (0, _dom.h)('p', ' Here are the definitions of the unfamiliar functions in bind(x)(prm5)(split2). '), (0, _dom.h)('pre', '  var prm5 = x => {\n    return new Promise( (resolve, reject) => {\n       mMZ39.bnd((y) => resolve(y)) \n   }).then(workerC.postMessage([primesMonad.s, [x]]));                         \n  }\n\n  function split2(str) {return str.split(\',\')}  '), (0, _dom.h)('h', ' The timeout in prm5 assures that the promise is returned before the message goes to the web worker. Here is the code involved in creating mMZ39: '), (0, _dom.h)('pre', '  var MonadItter = function MonadItter() {\n    this.p = function () {};\n    this.release = function () {\n      return this.p.apply(this, arguments);\n    };\n    this.bnd = function (func) {\n      return this.p = func;\n    }; \n  }\n\n  var MI = function MI() {\n    return new MonadItter();\n  };\n\n  var mMZ39 = MI(); '), (0, _dom.h)('p', ' A driver (Cycle.js terminology) puts messages sent by workerC into an xstream stream of messages.  The stream is transformed "main", the main application function, into another xstream stream that merges with other streams that together trigger Snabbdom\'s diff and render routine. '), (0, _dom.h)('p', ' The content of the trigger streams is ignored. Side effects of the transformation processes are all that matter. One of those side effects provides a string of comma separated numbers arriving from workerC to mM39.release() in pmr4.js. This is the driver: '), (0, _dom.h)('pre', '  function workerCDriver () {\n    return xs.create({\n      start: listener => { workerC.onmessage = msg => listener.next(msg)},\n      stop: () => { workerC.terminate() }\n    });\n  };'), (0, _dom.h)('p', ' Here is the code that receives numbers and requests their prime factors from workerC: '), (0, _dom.h)('pre', 'var factorsPress$ = sources.DOM\n  .select(\'input#factors_1\').events(\'keydown\');\n\n var factorsAction$ = factorsPress$.map(function (e) {\n  console.log(\'&&&&&>>> >> Cordial greetings from factorsAction$. e is\', e );\n    var factors = [];\n    mMfactors3.ret(\'\');\n    if (e.keyCode === 13) {\n      var num = e.target.value;\n      if (!num.match(/^[0-9]+$/)) {\n        mMfactors3.ret(\'You can try again. num + \' is not a number\');\n      }\n      else {\n        var n = parseInt(num, 10);\n        workerC.postMessage([primesMonad.s, [n]]);\n      }\n    }\n  }); '), (0, _dom.h)('p', ' Whenever a message, say "m", is added to the stream of messages coming out of workerC, it is mapped to methods and a constructor cause, among other things, mMZ39.release(m.data[1]) to execute. Here\'s the code: '), (0, _dom.h)('pre', '  const workerC$ = sources.WWC.map(m => {  // sources.WWC a/k/a workerCDriver\n    mMfactors.ret(m.data[0]);\n    mMfactors23.ret(m.data[1]);\n    mMZ39.release(m.data[1]);    // This line lets largestPrime proceed\n    window[\'primesMonad\'] = new MonadState(\'primesMonad\', m.data[2]);\n  });\n\n  const sources = {\n    DOM: makeDOMDriver(\'#main-container\'),\n    WS: websocketsDriver,\n    WWB: workerBDriver,\n    WWC: workerCDriver,\n    WWD: workerDDriver,\n    WWE: workerEDriver,\n    WWF: workerFDriver,\n    WW: workerDriver\n  }\n  run(main, sources);  // Sends and receives data to and from main. '), (0, _dom.h)('input#factors_1'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span', mMfactors.x), (0, _dom.h)('span.tao3', mMfactors23.x), (0, _dom.h)('h3', 'Comparison With Haskell'), (0, _dom.h)('span.tao', ' Values v that satisfy "v instanceof Monad" (what I call "monads" in this discussion) are very different from the Haskell monads, but they are similar in that both behave like the monads of category theory without actually being category theory monads. See '), (0, _dom.h)('a', { props: { href: "http://math.andrej.com/2016/08/06/hask-is-not-a-category/", target: "_blank" } }, 'Hask is not a category.'), (0, _dom.h)('span', ' by Andrej Bauer and the '), (0, _dom.h)('a', { props: { href: '#discussion' } }, 'Discussion'), (0, _dom.h)('span', ' below. They provide a convenient interface for dealing with uncertainty and side effects in a purely functional manner. Adherence to the monad laws (see below) helps instill confidence that the monads are robust, versatile, and reliable tools for isolating and chaining sequences of JavaScript functions. '), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span.tao', ' Reactivity occurs naturally in the Cycle.js framework. Some developers find that Cycle.js has a steep learning curve. It isn\'t so bad if you start with Andr Staltz\' '), (0, _dom.h)('a', { props: { href: "https://egghead.io/courses/cycle-js-fundamentals", target: "_blank" } }, ' Overview of Cycle.js.'), (0, _dom.h)('span', ' Its elegance might take your breath away. '), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span.tao', ' The monads do not depend on Cycle.js. They can be used in React, Node, and all other browser-based applications. I happen to prefer Cycle.js working in conjunction with a Haskell Websockets server. '), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span.tao', 'This project was created by and is actively maintained by me, David Schalk. The code repository is at '), (0, _dom.h)('a', { props: { href: "https://github.com/dschalk/monads-in-JavaScript", target: "_blank" } }, 'monads-in-JavaScript'), (0, _dom.h)('span', ' You can comment at '), (0, _dom.h)('a', { props: { href: 'https://redd.it/60c2xx' } }, 'Reddit'), (0, _dom.h)('span', ' or in the Comments section near the end of this page '), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('a', { props: { href: 'https://github.com/snabbdom/snabbdom' } }, ' Snabbdom'), (0, _dom.h)('a', { props: { href: 'http://x-stream.github.io/' } }, ' xstream,'), (0, _dom.h)('span', ' and most of the monads and functions presented here are available in browser developer tools consoles and scratch pads. A production site would load these as modules, but this site is for experimentation and learning so many supporting files are included as scripts in the index.html page. '), (0, _dom.h)('br'), (0, _dom.h)('h2', 'Alternative Monad Functionality'), (0, _dom.h)('p', ' Instances of Monad can also link by means of the method "bnd()". It, along with the method "ret()", were made available as follows: '), (0, _dom.h)('pre', { style: { color: "rgb(236, 242, 186)" } }, '  Monad.prototype.bnd = function (func, ...args) {\n    var m = func(this.x, ...args)\n    var ID;\n    if (m instanceof Monad) {\n      ID = testPrefix(args, this.id);\n      window[ID] = new Monad(m.x, ID);\n      return window[ID];\n    }\n    else return m;\n  };\n\n  Monad.prototype.ret = function (a) {\n    return window[this.id] = new Monad(a, this.id);\n  };\n     \n  function testPrefix (x,y) {\n     var t = y;  // y is the id of the monad calling testPrefix\n     if (Array.isArray(x)) {\n      x.map(v => {\n        if (typeof v == \'string\' && v.charAt() == \'$\') {\n           t = v.slice(1);  // Remove "$"\n        }\n      })\n    }\n    return t;\n  }; '), (0, _dom.h)('p', ' This seems less functional, less like Haskell. It doesn\'t pass functions down the chain but instead, it passes monads with exposed methods. But is has appealing features. Look how values move along the chain until, at the end they combine to yield 42. Explicitly passing values down the line is impossible with bind(); but with bind(), all functions have access to ar where they can find the values of every monad returned by previous functions. '), (0, _dom.h)('p', 'The code below resembles a lambda calculus expression, and the lambda calculus is the essence of functional programming, resting close to the eternal Tao. But intermediate functions along a linked chain of computations can instantiate monads in the global space, a feature which can be convenient and which doesn\'t have to be dangerous; but a function that uses this feature is not pure and impure functions are anathema to functional programming. '), (0, _dom.h)('pre', '  ret(2).bnd(v => add(v,1).bnd(cube).bnd(p => add(p,3)\n  .bnd(() => ret(p/3).bnd(add,3).bnd(z => [v,p,z,v*p-z]))))\n    // [1,27,12,42] '), (0, _dom.h)('h2', 'Haskell Monad Laws'), (0, _dom.h)('p', { style: { fontStyle: 'italic' } }, ' By the way, these are just suggestions in the Haskell programming language. I don\'t know how the word "law" caught on, but I see them present in the libraries I use. '), (0, _dom.h)('div', 'Left Identity '), (0, _dom.h)('pre', '  m.ret(v).bnd(f, ...args).x === f(v, ...args).x\n\n  ret(v).bnd(f, ...args).x === f(v, ...args).x\n\n  bind(a)(ret)(func, ...args)(terminate).pop() === f(a, ...args).x\n\n  Haskell monad law: (return x) >>= f \u2261 f x  '), (0, _dom.h)('div#discussion', ' Right Identity  '), (0, _dom.h)('pre', '  m.bnd(m.ret) === m  For all m where \n    (m.constructor === Monad) === true    \n\n  bind(a)(func, ...args)(ret)(terminate).pop() === func(a, ...args).x\n  // (ret) has no effect on either side of the function.\n  bind(3)(ret)(add,5)(ret)(terminate).pop() === add(3,5).x\n\n  Haskell monad law: m >>= return \u2261 m '), (0, _dom.h)('div', ' Commutivity  '), (0, _dom.h)('pre', '  eq(m.bnd(f, ...args).bnd(g, ...args), \n  m.bnd(v => f(v, ...args).bnd(g, ...args)))\n\n  eq(bind(ret(v))(f, ...args)(g, ...args)(terminate),\n   bind(ret(3,\'m\'))(x => f(x, ...args))(g, ...args)(terminate))\n\n  Haskell: (m >>= f) >>= g \u2261 m >>= ( \\x -> (f x >>= g) ) '), (0, _dom.h)('span', { style: { fontSize: "18px", fontStyle: "italic" } }, 'Examples demonstrating commutivity'), (0, _dom.h)('pre', '  eq(bind(ret(3))(ret)(cube)(ret)(terminate),\n    bind(ret(3))(cube)(terminate)) \n  \n  eq(m.ret(3).bnd(ret).bnd(cube).\n    bnd(ret),m.ret(3).bnd(cube)) '), (0, _dom.h)('p', ' The above relationships prove nothing, but they do suggest that the monads will turn out to be flexible and robust. The demonstrations below bear this out. '), (0, _dom.h)('a', { props: { href: '#top' } }, 'Back To The Top'), (0, _dom.h)('h3', ' Discussion '), (0, _dom.h)('span.tao', ' The Haskell statement '), (0, _dom.h)('span.turk6', 'f \u2261 g'), (0, _dom.h)('span', ' returns True if and only if f x == g x for all Haskell values x in the domains of f and g. That is what eq() tests for, in addition to identity of id attributes. In JavaScript, "==" and "===" return false for identical objects that are in different locations in memory.'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span.tao', ' The Haskell programming language borrowed the term "monad" from the branch of mathematics known as category theory. This was appropriate because Haskell monads, along with the function return and the "bind" operator >>=, behave quite a bit like category theory monads, and the inspiration for them came out of category theory. For Haskell monads to actually be category theory monads, they would need to reside in a category-theory category. They don\'t, although the Haskell mystique tends to give newcomers to the language the impression that they do. See '), (0, _dom.h)('a', { props: { href: "http://math.andrej.com/2016/08/06/hask-is-not-a-category/", target: "_blank" } }, 'Hask is not a category.'), (0, _dom.h)('br'), (0, _dom.h)('p', ' Research into ways of defining a Haskell category appears to be ongoing. This research involves tinkering with special constraints, omitted features, and definitions of morphisms that are not Haskell functions. When a definition of the category is established, Haskell monads are then shown to be, in some contrived context, category-theory monads. Devising such schemes are instructive academic exercises, but I think application developers will always want and need tools which lie outside of the closed space of any category. '), (0, _dom.h)('p', ' However, imitating definitions and patterns found in category theory, as Haskell does in defining the functor, monoid, and monad type classes, was a stroke of genius that vastly enriched the Haskell programming language and brought it into the mainstream as a viable alternative to java, c++, etc.  This website runs efficiently on a Haskell websockets server. The modified Haskell Wai Websockets server has proven to be extraordinarily easy to maintain as new requirements become necessary. For example, modifying the server to send chat messages and shared todo lists only to members of the same group was a trivial task. It required just a few lines of no-brainer pattern-matching code. '), (0, _dom.h)('span.tao', ' Other JavaScript monad schemes mirror type theory and Haskell with their type constructors and monads that operate on types. Examples include '), (0, _dom.h)('a', { props: { href: "https://curiosity-driven.org/monads-in-javascript" } }, "Curiosity-Driven"), (0, _dom.h)('span', ' and '), (0, _dom.h)('a', { props: { href: "https://github.com/fantasyland/fantasy-land" } }, "Fantasy Land."), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('span', ' For me, superimposing such abstractions over JavaScript takes too much versatility away from it. It is easy to include some type checking code in function definitions where it is thought to be helpful. For example, if someone enters inappropriate data in a form, a message explaining the mistake can be displayed. I enjoy the freedom and built-in polymorphism of JavaScript as it is. Call me an anarchist. '),
