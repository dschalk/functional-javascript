	...
	function main(sources) {
	  ...
	  */
	  ...
	  var demo2Action$ = printingPress$.map(function (e) {
	    ...
	    if (e.keyCode === 13) {
	      bind3(3, [], 'jim7')(cubeP)(addP(3))(function (a) {
	        return a + jim7[0] + jim7[1] - 18;
	      })(multP(1 / 3))(addP(-11))(function () {
	        return jim7[1] + jim7[2] + jim7[3];
	      })(terminate);
	    }
	  });
