/*
	Rollup.js v0.60.7
	Thu, 14 Jun 2018 06:43:21 GMT - commit 6e004184ede79832e658c22983de439aa5c30462
...
var UnknownArrayExpression = /** @class */ (function () {
    ...
    UnknownArrayExpression.prototype.reassignPath = function () { };
...
var UnknownObjectExpression = /** @class */ (function () {
    ...
    UnknownObjectExpression.prototype.reassignPath = function () { };
...
var Variable = /** @class */ (function () {
    ...
    Variable.prototype.getLiteralValueAtPath = function (_path, _recursionTracker) {
        return UNKNOWN_VALUE;
    };
    Variable.prototype.getReturnExpressionWhenCalledAtPath = function (_path, _recursionTracker) {
        return UNKNOWN_EXPRESSION;
    };
    ...
    Variable.prototype.reassignPath = function (_path) { };
...
var LocalVariable = /** @class */ (function (_super) {
    ...
    function LocalVariable(name, declarator, init, reassignmentTracker) {
        var _this = _super.call(this, name) || this;
        _this.declarations = declarator ? [declarator] : [];
        _this.init = init;
        _this.reassignmentTracker = reassignmentTracker;
        return _this;
    }
    LocalVariable.prototype.addDeclaration = function (identifier) {
        this.declarations.push(identifier);
    };
    LocalVariable.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        ...
        return this.init.getLiteralValueAtPath(path$$1, recursionTracker.track(this.init, path$$1));
    };
    LocalVariable.prototype.getReturnExpressionWhenCalledAtPath = function (path$$1, recursionTracker) {
        if (this.isReassigned ||
            !this.init ||
            path$$1.length > MAX_PATH_DEPTH ||
            recursionTracker.isTracked(this.init, path$$1)) {
        ...
        return this.init.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker.track(this.init, path$$1));
    };
    ...
    LocalVariable.prototype.reassignPath = function (path$$1) {
        if (path$$1.length > MAX_PATH_DEPTH)
            return;
        if (!(this.isReassigned || this.reassignmentTracker.track(this, path$$1))) {
            if (path$$1.length === 0) {
...
var ExportDefaultVariable = /** @class */ (function (_super) {
    ...
    function ExportDefaultVariable(name, exportDefaultDeclaration, reassignmentTracker) {
        var _this = _super.call(this, name, exportDefaultDeclaration, exportDefaultDeclaration.declaration, reassignmentTracker) || this;
        // Not initialised during construction
        _this.original = null;
...
var Scope = /** @class */ (function () {
    ...
    Scope.prototype.addDeclaration = function (identifier, reassignmentTracker, init, _isHoisted) {
        ...
        if (this.variables[name]) {
            ...
            this.variables[name] = new LocalVariable(identifier.name, identifier, init || UNDEFINED_EXPRESSION, reassignmentTracker);
        }
        return this.variables[name];
    };
    Scope.prototype.addExportDefaultDeclaration = function (name, exportDefaultDeclaration, reassignmentTracker) {
        this.variables.default = new ExportDefaultVariable(name, exportDefaultDeclaration, reassignmentTracker);
...
var NodeBase = /** @class */ (function () {
    ...
    NodeBase.prototype.getLiteralValueAtPath = function (_path, _recursionTracker) {
        return UNKNOWN_VALUE;
    };
    NodeBase.prototype.getReturnExpressionWhenCalledAtPath = function (_path, _recursionTracker) {
        return UNKNOWN_EXPRESSION;
    };
    ...
    NodeBase.prototype.reassignPath = function (_path) { };
...
var ArgumentsVariable = /** @class */ (function (_super) {
    ...
    function ArgumentsVariable(parameters, reassignmentTracker) {
        var _this = _super.call(this, 'arguments', null, UNKNOWN_EXPRESSION, reassignmentTracker) || this;
    ...
    ArgumentsVariable.prototype.reassignPath = function (path$$1) {
        var firstArgNum = parseInt(path$$1[0], 10);
        if (path$$1.length > 0) {
            if (firstArgNum >= 0 && this.parameters[firstArgNum]) {
                this.parameters[firstArgNum].reassignPath(path$$1.slice(1));
            }
        }
    };
...
var ReplaceableInitializationVariable = /** @class */ (function (_super) {
    ...
    function ReplaceableInitializationVariable(name, declarator, reassignmentTracker) {
        return _super.call(this, name, declarator, null, reassignmentTracker) || this;
    }
...
var ThisVariable = /** @class */ (function (_super) {
    ...
    function ThisVariable(reassignmentTracker) {
        return _super.call(this, 'this', null, reassignmentTracker) || this;
    }
    return ThisVariable;
...
var ParameterVariable = /** @class */ (function (_super) {
    ...
    function ParameterVariable(identifier, reassignmentTracker) {
        return _super.call(this, identifier.name, identifier, reassignmentTracker) || this;
    }
...
var ParameterScope = /** @class */ (function (_super) {
     ...
     * @returns {Variable}
     */
    ParameterScope.prototype.addParameterDeclaration = function (identifier, reassignmentTracker) {
        var variable = new ParameterVariable(identifier, reassignmentTracker);
...
var FunctionScope = /** @class */ (function (_super) {
    ...
    function FunctionScope(parent, reassignmentTracker) {
        var _this = _super.call(this, parent) || this;
        _this.variables.arguments = new ArgumentsVariable(_super.prototype.getParameterVariables.call(_this), reassignmentTracker);
        _this.variables.this = new ThisVariable(reassignmentTracker);
        return _this;
    }
...
var Identifier$1 = /** @class */ (function (_super) {
    ...
    Identifier$$1.prototype.declare = function (kind, init) {
        switch (kind) {
            case 'var':
            case 'function':
                this.variable = this.scope.addDeclaration(this, this.context.reassignmentTracker, init, true);
                break;
            case 'let':
            case 'const':
            case 'class':
                this.variable = this.scope.addDeclaration(this, this.context.reassignmentTracker, init, false);
                break;
            case 'parameter':
                this.variable = this.scope.addParameterDeclaration(this, this.context.reassignmentTracker);
                break;
            default:
                throw new Error("Unexpected identifier kind " + kind + ".");
        }
    };
    Identifier$$1.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        if (this.variable !== null) {
            return this.variable.getLiteralValueAtPath(path$$1, recursionTracker);
        }
        return UNKNOWN_VALUE;
    };
    Identifier$$1.prototype.getReturnExpressionWhenCalledAtPath = function (path$$1, recursionTracker) {
        if (this.variable !== null) {
            return this.variable.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker);
        }
        return UNKNOWN_EXPRESSION;
    };
    ...
    Identifier$$1.prototype.reassignPath = function (path$$1) {
        if (!this.bound)
            this.bind();
        if (this.variable !== null) {
            if (path$$1.length === 0 &&
            ...
            this.variable.reassignPath(path$$1);
        }
    };
...
var ExportDefaultDeclaration$1 = /** @class */ (function (_super) {
    ...
    ExportDefaultDeclaration$$1.prototype.initialise = function () {
        ...
        this.variable = this.scope.addExportDefaultDeclaration(this.declarationName || this.context.getModuleName(), this, this.context.reassignmentTracker);
...
var ArrayPattern$1 = /** @class */ (function (_super) {
    ...
    ArrayPattern.prototype.reassignPath = function (path$$1) {
        if (path$$1.length === 0) {
            for (var _i = 0, _a = this.elements; _i < _a.length; _i++) {
                var element = _a[_i];
                if (element !== null) {
                    element.reassignPath(path$$1);
                }
            }
        }
    };
...
var BlockScope = /** @class */ (function (_super) {
    ...
    BlockScope.prototype.addDeclaration = function (identifier, reassignmentTracker, init, isHoisted) {
        if (init === void 0) { init = null; }
        if (isHoisted === void 0) { isHoisted = false; }
        if (isHoisted) {
            return this.parent.addDeclaration(identifier, reassignmentTracker, init, true);
        }
        else {
            return _super.prototype.addDeclaration.call(this, identifier, reassignmentTracker, init, false);
        }
    };
    return BlockScope;
}(Scope));
...
var AssignmentPattern$1 = /** @class */ (function (_super) {
    ...
    AssignmentPattern.prototype.reassignPath = function (path$$1) {
        path$$1.length === 0 && this.left.reassignPath(path$$1);
    };
...
var BinaryExpression$1 = /** @class */ (function (_super) {
    ...
    BinaryExpression.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        if (path$$1.length > 0)
            return UNKNOWN_VALUE;
        var leftValue = this.left.getLiteralValueAtPath(EMPTY_PATH, recursionTracker);
        if (leftValue === UNKNOWN_VALUE)
            return UNKNOWN_VALUE;
        var rightValue = this.right.getLiteralValueAtPath(EMPTY_PATH, recursionTracker);
...
var CallExpression$1 = /** @class */ (function (_super) {
    ...
    CallExpression.prototype.bind = function () {
        ...
        if (this.returnExpression === null) {
            this.returnExpression = this.callee.getReturnExpressionWhenCalledAtPath(EMPTY_PATH, EMPTY_IMMUTABLE_TRACKER);
        }
    ...
    CallExpression.prototype.getReturnExpressionWhenCalledAtPath = function (path$$1, recursionTracker) {
        if (this.returnExpression === null) {
            this.returnExpression = this.callee.getReturnExpressionWhenCalledAtPath(EMPTY_PATH, recursionTracker);
        }
        if (recursionTracker.isTracked(this.returnExpression, path$$1)) {
            return UNKNOWN_EXPRESSION;
        }
        return this.returnExpression.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker.track(this.returnExpression, path$$1));
    };
    ...
    CallExpression.prototype.reassignPath = function (path$$1) {
        if (path$$1.length > 0 && !this.context.reassignmentTracker.track(this, path$$1)) {
            if (this.returnExpression === null) {
                this.returnExpression = this.callee.getReturnExpressionWhenCalledAtPath(EMPTY_PATH, EMPTY_IMMUTABLE_TRACKER);
            }
            this.returnExpression.reassignPath(path$$1);
        }
    };
...
var CatchScope = /** @class */ (function (_super) {
    ...
    CatchScope.prototype.addDeclaration = function (identifier, reassignmentTracker, init, isHoisted) {
        if (init === void 0) { init = null; }
        if (isHoisted === void 0) { isHoisted = false; }
        if (isHoisted) {
            return this.parent.addDeclaration(identifier, reassignmentTracker, init, true);
...
var ConditionalExpression$1 = /** @class */ (function (_super) {
    ...
    ConditionalExpression.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        ...
        if (testValue === UNKNOWN_VALUE)
            return UNKNOWN_VALUE;
        return testValue
            ? this.consequent.getLiteralValueAtPath(path$$1, recursionTracker)
            : this.alternate.getLiteralValueAtPath(path$$1, recursionTracker);
    };
    ConditionalExpression.prototype.getReturnExpressionWhenCalledAtPath = function (path$$1, recursionTracker) {
        var testValue = this.hasUnknownTestValue
            ? UNKNOWN_VALUE
        ...
        if (testValue === UNKNOWN_VALUE)
            return UNKNOWN_EXPRESSION;
        return testValue
            ? this.consequent.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker)
            : this.alternate.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker);
    };
    ...
    ConditionalExpression.prototype.reassignPath = function (path$$1) {
        if (path$$1.length > 0) {
            var testValue = this.hasUnknownTestValue
                ? UNKNOWN_VALUE
                : this.getTestValue(EMPTY_IMMUTABLE_TRACKER);
            if (testValue === UNKNOWN_VALUE || testValue) {
                this.consequent.reassignPath(path$$1);
            }
            if (testValue === UNKNOWN_VALUE || !testValue) {
                this.alternate.reassignPath(path$$1);
            }
        }
    };
    ...
    ConditionalExpression.prototype.getTestValue = function (recursionTracker) {
        if (this.hasUnknownTestValue)
            return UNKNOWN_VALUE;
        var value = this.test.getLiteralValueAtPath(EMPTY_PATH, recursionTracker);
...
var IfStatement$1 = /** @class */ (function (_super) {
    ...
    IfStatement.prototype.getTestValue = function () {
        if (this.hasUnknownTestValue)
            return UNKNOWN_VALUE;
        var value = this.test.getLiteralValueAtPath(EMPTY_PATH, EMPTY_IMMUTABLE_TRACKER);
        if (value === UNKNOWN_VALUE) {
            this.hasUnknownTestValue = true;
        }
        return value;
...
var LogicalExpression$1 = /** @class */ (function (_super) {
    ...
    LogicalExpression.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        ...
        if (this.isOrExpression ? leftValue : !leftValue)
            return leftValue;
        return this.right.getLiteralValueAtPath(path$$1, recursionTracker);
    };
    LogicalExpression.prototype.getReturnExpressionWhenCalledAtPath = function (path$$1, recursionTracker) {
        var leftValue = this.hasUnknownLeftValue
            ? UNKNOWN_VALUE
        ...
        if (leftValue === UNKNOWN_VALUE)
            return UNKNOWN_EXPRESSION;
        if (this.isOrExpression ? leftValue : !leftValue)
            return this.left.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker);
        return this.right.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker);
    };
    ...
    LogicalExpression.prototype.reassignPath = function (path$$1) {
        if (path$$1.length > 0) {
            var leftValue = this.hasUnknownLeftValue
                ? UNKNOWN_VALUE
                : this.getLeftValue(EMPTY_IMMUTABLE_TRACKER);
            if (leftValue === UNKNOWN_VALUE) {
                this.left.reassignPath(path$$1);
                this.right.reassignPath(path$$1);
            }
    ...
    LogicalExpression.prototype.getLeftValue = function (recursionTracker) {
        if (this.hasUnknownLeftValue)
            return UNKNOWN_VALUE;
        var value = this.left.getLiteralValueAtPath(EMPTY_PATH, recursionTracker);
        if (value === UNKNOWN_VALUE) {
...
var MemberExpression$1 = /** @class */ (function (_super) {
    ...
    MemberExpression$$1.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        if (this.variable !== null) {
            return this.variable.getLiteralValueAtPath(path$$1, recursionTracker);
        }
        return this.object.getLiteralValueAtPath([this.propertyKey || this.getComputedKey(recursionTracker)].concat(path$$1), recursionTracker);
    };
    MemberExpression$$1.prototype.getReturnExpressionWhenCalledAtPath = function (path$$1, recursionTracker) {
        if (this.variable !== null) {
            return this.variable.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker);
        }
        return this.object.getReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey(EMPTY_IMMUTABLE_TRACKER)].concat(path$$1), recursionTracker);
    };
    MemberExpression$$1.prototype.hasEffects = function (options) {
        return (this.property.hasEffects(options) ||
            ...
            (this.context.propertyReadSideEffects &&
                this.object.hasEffectsWhenAccessedAtPath([this.propertyKey || this.getComputedKey(EMPTY_IMMUTABLE_TRACKER)], options)));
    };
    MemberExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path$$1, options) {
        ...
        return this.object.hasEffectsWhenAccessedAtPath([this.propertyKey || this.getComputedKey(EMPTY_IMMUTABLE_TRACKER)].concat(path$$1), options);
    };
    MemberExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path$$1, options) {
        ...
        return this.object.hasEffectsWhenAssignedAtPath([this.propertyKey || this.getComputedKey(EMPTY_IMMUTABLE_TRACKER)].concat(path$$1), options);
    };
    MemberExpression$$1.prototype.hasEffectsWhenCalledAtPath = function (path$$1, callOptions, options) {
        ...
        return this.object.hasEffectsWhenCalledAtPath([this.propertyKey || this.getComputedKey(EMPTY_IMMUTABLE_TRACKER)].concat(path$$1), callOptions, options);
    };
    ...
    MemberExpression$$1.prototype.reassignPath = function (path$$1) {
        if (!this.bound)
            this.bind();
        if (path$$1.length === 0)
    ...
    MemberExpression$$1.prototype.getComputedKey = function (recursionTracker) {
        var value = this.property.getLiteralValueAtPath(EMPTY_PATH, recursionTracker);
...
var ObjectExpression$1 = /** @class */ (function (_super) {
    ...
    ObjectExpression$$1.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        var key = path$$1[0];
        if (path$$1.length === 0 ||
            this.hasUnknownReassignedProperty ||
            (typeof key === 'string' && this.reassignedPaths[key]))
            return UNKNOWN_VALUE;
        var _a = this.getPossiblePropertiesWithName(path$$1[0], PROPERTY_KINDS_READ, recursionTracker), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (!hasCertainHit || properties.length > 1)
            return UNKNOWN_VALUE;
        return properties[0].getLiteralValueAtPath(path$$1.slice(1), recursionTracker);
    };
    ObjectExpression$$1.prototype.getReturnExpressionWhenCalledAtPath = function (path$$1, recursionTracker) {
        var key = path$$1[0];
        if (path$$1.length === 0 ||
            this.hasUnknownReassignedProperty ||
            (typeof key === 'string' && this.reassignedPaths[key]))
            return UNKNOWN_EXPRESSION;
        var _a = this.getPossiblePropertiesWithName(key, PROPERTY_KINDS_READ, EMPTY_IMMUTABLE_TRACKER), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (path$$1.length === 1 &&
            typeof key === 'string' &&
            objectMembers[key] &&
            properties.length === 0)
        ...
        if (!hasCertainHit || properties.length > 1)
            return UNKNOWN_EXPRESSION;
        return properties[0].getReturnExpressionWhenCalledAtPath(path$$1.slice(1), recursionTracker);
    };
    ObjectExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path$$1, options) {
        ...
        if (path$$1.length > 1 &&
            ...
            return true;
        var _a = this.getPossiblePropertiesWithName(path$$1[0], PROPERTY_KINDS_READ, EMPTY_IMMUTABLE_TRACKER), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
    ...
    ObjectExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path$$1, options) {
        ...
        if (path$$1.length > 1 &&
            (this.hasUnknownReassignedProperty || (typeof key === 'string' && this.reassignedPaths[key])))
            return true;
        var _a = this.getPossiblePropertiesWithName(path$$1[0], path$$1.length === 1 ? PROPERTY_KINDS_WRITE : PROPERTY_KINDS_READ, EMPTY_IMMUTABLE_TRACKER), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (path$$1.length > 1 && !hasCertainHit)
            return true;
        var subPath = path$$1.slice(1);
    ...
    ObjectExpression$$1.prototype.reassignPath = function (path$$1) {
        ...
        var properties = this.getPossiblePropertiesWithName(path$$1[0], PROPERTY_KINDS_READ, EMPTY_IMMUTABLE_TRACKER).properties;
        var subPath = path$$1.length === 1 ? UNKNOWN_PATH : path$$1.slice(1);
        for (var _b = 0, properties_4 = properties; _b < properties_4.length; _b++) {
            var property = properties_4[_b];
    ...
    ObjectExpression$$1.prototype.getPossiblePropertiesWithName = function (name, kinds, recursionTracker) {
        if (name === UNKNOWN_KEY) {
        ...
        for (var index = this.properties.length - 1; index >= 0; index--) {
            ...
            if (property.computed) {
                var value = property.key.getLiteralValueAtPath(EMPTY_PATH, recursionTracker);
...
var ObjectPattern$1 = /** @class */ (function (_super) {
    ...
    ObjectPattern.prototype.reassignPath = function (path$$1) {
        if (path$$1.length === 0) {
            for (var _i = 0, _a = this.properties; _i < _a.length; _i++) {
                var property = _a[_i];
                property.reassignPath(path$$1);
            }
        }
    };
...
var Property$1 = /** @class */ (function (_super) {
    ...
    Property.prototype.bind = function () {
        ...
        if (this.kind === 'get' && this.returnExpression === null) {
            this.returnExpression = this.value.getReturnExpressionWhenCalledAtPath(EMPTY_PATH, EMPTY_IMMUTABLE_TRACKER);
        }
    };
    Property.prototype.declare = function (kind, _init) {
        this.value.declare(kind, UNKNOWN_EXPRESSION);
    };
    Property.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        if (this.kind === 'get') {
            if (this.returnExpression === null) {
                this.returnExpression = this.value.getReturnExpressionWhenCalledAtPath(EMPTY_PATH, EMPTY_IMMUTABLE_TRACKER);
            }
            return this.returnExpression.getLiteralValueAtPath(path$$1, recursionTracker);
        }
        return this.value.getLiteralValueAtPath(path$$1, recursionTracker);
    };
    Property.prototype.getReturnExpressionWhenCalledAtPath = function (path$$1, recursionTracker) {
        if (this.kind === 'set') {
            return UNKNOWN_EXPRESSION;
        }
        if (this.kind === 'get') {
            ...
            return this.returnExpression.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker);
        }
        return this.value.getReturnExpressionWhenCalledAtPath(path$$1, recursionTracker);
    };
    ...
    Property.prototype.reassignPath = function (path$$1) {
        if (this.kind === 'get') {
            if (path$$1.length > 0) {
                if (this.returnExpression === null) {
                    this.returnExpression = this.value.getReturnExpressionWhenCalledAtPath(EMPTY_PATH, EMPTY_IMMUTABLE_TRACKER);
            ...
            this.value.reassignPath(path$$1);
        }
    };
...
var RestElement$1 = /** @class */ (function (_super) {
    ...
    RestElement.prototype.reassignPath = function (path$$1) {
        path$$1.length === 0 && this.argument.reassignPath(EMPTY_PATH);
    };
    return RestElement;
}(NodeBase));
...
var SequenceExpression$1 = /** @class */ (function (_super) {
    ...
    SequenceExpression.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        return this.expressions[this.expressions.length - 1].getLiteralValueAtPath(path$$1, recursionTracker);
    };
    ...
    SequenceExpression.prototype.reassignPath = function (path$$1) {
        if (path$$1.length > 0)
            this.expressions[this.expressions.length - 1].reassignPath(path$$1);
    };
...
var UnaryExpression$1 = /** @class */ (function (_super) {
    ...
    UnaryExpression.prototype.getLiteralValueAtPath = function (path$$1, recursionTracker) {
        if (path$$1.length > 0)
            return UNKNOWN_VALUE;
        var argumentValue = this.argument.getLiteralValueAtPath(EMPTY_PATH, recursionTracker);
...
var VariableDeclaration$1 = /** @class */ (function (_super) {
    ...
    VariableDeclaration$$1.prototype.reassignPath = function (_path) {
        for (var _i = 0, _a = this.declarations; _i < _a.length; _i++) {
            var declarator = _a[_i];
...
var VariableDeclarator$1 = /** @class */ (function (_super) {
    ...
    VariableDeclarator.prototype.reassignPath = function (path$$1) {
        this.id.reassignPath(path$$1);
    };
...
var ModuleScope = /** @class */ (function (_super) {
    ...
    function ModuleScope(parent, context) {
        ...
        _this.variables.this = new LocalVariable('this', null, UNDEFINED_EXPRESSION, context.reassignmentTracker);
        return _this;
    }
