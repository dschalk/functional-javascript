...
(function (global, factory) {
  ...
  var LocalVariable = /** @class */ (function (_super) {
      ...
      LocalVariable.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
      ...
      LocalVariable.prototype.getReturnExpressionWhenCalledAtPath = function (path, recursionTracker) {
          if (this.isReassigned ||
              !this.init ||
              path.length > MAX_PATH_DEPTH ||
              recursionTracker.isTracked(this.init, path)) {
          ...
          return this.init.getReturnExpressionWhenCalledAtPath(path, recursionTracker.track(this.init, path));
      };
      ...
      LocalVariable.prototype.reassignPath = function (path) {
          if (path.length > MAX_PATH_DEPTH)
              return;
  ...
  var ArgumentsVariable = /** @class */ (function (_super) {
      ...
      ArgumentsVariable.prototype.reassignPath = function (path) {
          var firstArgNum = parseInt(path[0], 10);
          if (path.length > 0) {
  ...
  var Identifier$1 = /** @class */ (function (_super) {
      ...
      Identifier$$1.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
          if (this.variable !== null) {
              return this.variable.getLiteralValueAtPath(path, recursionTracker);
          }
          return UNKNOWN_VALUE;
      };
      Identifier$$1.prototype.getReturnExpressionWhenCalledAtPath = function (path, recursionTracker) {
          if (this.variable !== null) {
      ...
      Identifier$$1.prototype.reassignPath = function (path) {
          if (!this.bound)
              this.bind();
          if (this.variable !== null) {
              if (path.length === 0 &&
  ...
  var ArrayPattern$1 = /** @class */ (function (_super) {
      ...
      ArrayPattern.prototype.reassignPath = function (path) {
          if (path.length === 0) {
              for (var _i = 0, _a = this.elements; _i < _a.length; _i++) {
                  var element = _a[_i];
                  if (element !== null) {
  ...
  var AssignmentPattern$1 = /** @class */ (function (_super) {
      ...
      AssignmentPattern.prototype.reassignPath = function (path) {
  ...
  var BinaryExpression$1 = /** @class */ (function (_super) {
      ...
      BinaryExpression.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
          if (path.length > 0)
              return UNKNOWN_VALUE;
  ...
  var CallExpression$1 = /** @class */ (function (_super) {
      ...
      CallExpression.prototype.getReturnExpressionWhenCalledAtPath = function (path, recursionTracker) {
          if (this.returnExpression === null) {
          ...
          return this.returnExpression.getReturnExpressionWhenCalledAtPath(path, recursionTracker.track(this.returnExpression, path));
      };
      ...
      CallExpression.prototype.reassignPath = function (path) {
  ...
  var ConditionalExpression$1 = /** @class */ (function (_super) {
      ...
      ConditionalExpression.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
      ...
      ConditionalExpression.prototype.getReturnExpressionWhenCalledAtPath = function (path, recursionTracker) {
          var testValue = this.hasUnknownTestValue
              ? UNKNOWN_VALUE
      ...
      ConditionalExpression.prototype.reassignPath = function (path) {
          if (path.length > 0) {
              var testValue = this.hasUnknownTestValue
                  ? UNKNOWN_VALUE
                  : this.getTestValue(EMPTY_IMMUTABLE_TRACKER);
  ...
  var LogicalExpression$1 = /** @class */ (function (_super) {
      ...
      LogicalExpression.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
      ...
      LogicalExpression.prototype.getReturnExpressionWhenCalledAtPath = function (path, recursionTracker) {
          var leftValue = this.hasUnknownLeftValue
              ? UNKNOWN_VALUE
      ...
      LogicalExpression.prototype.reassignPath = function (path) {
          if (path.length > 0) {
              var leftValue = this.hasUnknownLeftValue
                  ? UNKNOWN_VALUE
                  : this.getLeftValue(EMPTY_IMMUTABLE_TRACKER);
  ...
  var MemberExpression$1 = /** @class */ (function (_super) {
      ...
      MemberExpression$$1.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
          if (this.variable !== null) {
              return this.variable.getLiteralValueAtPath(path, recursionTracker);
          }
          return this.object.getLiteralValueAtPath([this.propertyKey || this.getComputedKey(recursionTracker)].concat(path), recursionTracker);
      };
      MemberExpression$$1.prototype.getReturnExpressionWhenCalledAtPath = function (path, recursionTracker) {
          if (this.variable !== null) {
              return this.variable.getReturnExpressionWhenCalledAtPath(path, recursionTracker);
          }
          return this.object.getReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey(EMPTY_IMMUTABLE_TRACKER)].concat(path), recursionTracker);
      };
      ...
      MemberExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path, options) {
          ...
          return this.object.hasEffectsWhenAccessedAtPath([this.propertyKey || this.getComputedKey(EMPTY_IMMUTABLE_TRACKER)].concat(path), options);
      };
      MemberExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path, options) {
          if (this.variable !== null) {
              return this.variable.hasEffectsWhenAssignedAtPath(path, options);
          }
          return this.object.hasEffectsWhenAssignedAtPath([this.propertyKey || this.getComputedKey(EMPTY_IMMUTABLE_TRACKER)].concat(path), options);
      };
      MemberExpression$$1.prototype.hasEffectsWhenCalledAtPath = function (path, callOptions, options) {
          ...
          return this.object.hasEffectsWhenCalledAtPath([this.propertyKey || this.getComputedKey(EMPTY_IMMUTABLE_TRACKER)].concat(path), callOptions, options);
      };
      ...
      MemberExpression$$1.prototype.reassignPath = function (path) {
          if (!this.bound)
              this.bind();
          if (path.length === 0)
  ...
  var ObjectExpression$1 = /** @class */ (function (_super) {
      ...
      ObjectExpression$$1.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
          var key = path[0];
          if (path.length === 0 ||
              this.hasUnknownReassignedProperty ||
              (typeof key === 'string' && this.reassignedPaths[key]))
              return UNKNOWN_VALUE;
          var _a = this.getPossiblePropertiesWithName(path[0], PROPERTY_KINDS_READ, recursionTracker), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
          if (!hasCertainHit || properties.length > 1)
              return UNKNOWN_VALUE;
          return properties[0].getLiteralValueAtPath(path.slice(1), recursionTracker);
      };
      ObjectExpression$$1.prototype.getReturnExpressionWhenCalledAtPath = function (path, recursionTracker) {
          var key = path[0];
          if (path.length === 0 ||
              this.hasUnknownReassignedProperty ||
              (typeof key === 'string' && this.reassignedPaths[key]))
      ...
      ObjectExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path, options) {
          ...
          if (path.length > 1 &&
              ...
              return true;
          var _a = this.getPossiblePropertiesWithName(path[0], PROPERTY_KINDS_READ, EMPTY_IMMUTABLE_TRACKER), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
      ...
      ObjectExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path, options) {
          ...
          if (path.length > 1 &&
              (this.hasUnknownReassignedProperty || (typeof key === 'string' && this.reassignedPaths[key])))
              return true;
          var _a = this.getPossiblePropertiesWithName(path[0], path.length === 1 ? PROPERTY_KINDS_WRITE : PROPERTY_KINDS_READ, EMPTY_IMMUTABLE_TRACKER), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
          if (path.length > 1 && !hasCertainHit)
              return true;
          var subPath = path.slice(1);
      ...
      ObjectExpression$$1.prototype.reassignPath = function (path) {
          ...
          var properties = this.getPossiblePropertiesWithName(path[0], PROPERTY_KINDS_READ, EMPTY_IMMUTABLE_TRACKER).properties;
  ...
  var ObjectPattern$1 = /** @class */ (function (_super) {
      ...
      ObjectPattern.prototype.reassignPath = function (path) {
          if (path.length === 0) {
              for (var _i = 0, _a = this.properties; _i < _a.length; _i++) {
                  var property = _a[_i];
  ...
  var Property$1 = /** @class */ (function (_super) {
      ...
      Property.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
          if (this.kind === 'get') {
              if (this.returnExpression === null) {
                  this.returnExpression = this.value.getReturnExpressionWhenCalledAtPath(EMPTY_PATH, EMPTY_IMMUTABLE_TRACKER);
              }
      ...
      Property.prototype.getReturnExpressionWhenCalledAtPath = function (path, recursionTracker) {
          if (this.kind === 'set') {
              return UNKNOWN_EXPRESSION;
          }
          if (this.kind === 'get') {
      ...
      Property.prototype.reassignPath = function (path) {
          if (this.kind === 'get') {
              if (path.length > 0) {
                  if (this.returnExpression === null) {
                      this.returnExpression = this.value.getReturnExpressionWhenCalledAtPath(EMPTY_PATH, EMPTY_IMMUTABLE_TRACKER);
  ...
  var RestElement$1 = /** @class */ (function (_super) {
      ...
      RestElement.prototype.reassignPath = function (path) {
  ...
  var SequenceExpression$1 = /** @class */ (function (_super) {
      ...
      SequenceExpression.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
          return this.expressions[this.expressions.length - 1].getLiteralValueAtPath(path, recursionTracker);
      };
      ...
      SequenceExpression.prototype.reassignPath = function (path) {
          if (path.length > 0)
              this.expressions[this.expressions.length - 1].reassignPath(path);
      };
  ...
  var UnaryExpression$1 = /** @class */ (function (_super) {
      ...
      UnaryExpression.prototype.getLiteralValueAtPath = function (path, recursionTracker) {
          if (path.length > 0)
              return UNKNOWN_VALUE;
  ...
  var VariableDeclarator$1 = /** @class */ (function (_super) {
      ...
      VariableDeclarator.prototype.reassignPath = function (path) {
